...
export const zhCN: Record<string, string> = {
    "e.g. E-commerce platform": "电商平台",
  "e.g. Requirements analysis": "需求分析",
  "Task description": "任务描述",
  "Name": "名称",
  "Quality feedback (optional)": "质量意见（可选）",
  "e.g. E-commerce platform development": "电商平台开发",
  "/workspace/e-commerce-platform": "/workspace/电商平台",
"Todo": "待办",
  "In progress": "进行中",
  "In review": "待验收",
  "Completed": "已完成",
  ...
  "Remove": "移除",
  "Add member user_id": "添加成员 user_id",
  "Main task": "主任务",
  "Subtask": "任务",
  "Close": "关闭",
  "Edit YAML": "编辑 YAML",
  "No execution session yet (collab tree appears after launch)": "暂无执行会话（任务启动后显示协作树）",
  "No sessions yet": "暂无会话",
  "(Official: default workspace/host/memory/context)": "（官方功能：默认工作目录/主机/记忆/上下文）",
  "New sessions/tasks prefill this dir (soft hint, overridable)": "新会话/任务预填此目录（软提示，可覆盖）",
  "Unspecified (executor chooses)": "不指定（由执行者选）",
  "New sessions prefill this host (dropped if offline)": "新会话预填此主机（host 离线则丢弃）",
  "Project memory (cross-session experience, seeded into every task session)": "项目级记忆（跨会话累积的经验，播种到每个任务会话）",
  "Project instructions/docs (injected into every task session)": "项目级指令/文档（每个任务会话注入）",
  "Project members": "项目成员",
  "Flow list": "流程列表",
  "No projects yet — create one via 「New team project」 on the Tasks page.": "暂无项目 — 在任务页「新建团队项目」创建。",
  ...
  "Task title": "任务标题",
  "Add task": "添加任务",
  "Awaiting dependency": "等依赖",
  "Execution graph": "执行关系图",
  ...
  "Loading…": "加载中…",
  "Local CLI": "本地 CLI",
  "This machine is connected as a runner": "此机器已作为执行机连接",
  "This machine is not connected as a runner": "此机器尚未作为执行机连接",
  "Connect this machine as a runner": "将此机器连接为执行机",
  "Disconnect this machine": "断开此机器",
  "Restart": "重启",
  "Working…": "处理中…",
  "Keeps this machine connected to the server as an execution host while the desktop app is open.": "桌面应用打开期间，保持此机器作为执行机连接到服务器。",
  "Local machine": "本机",
  "Log in": "登录",
  "Log out": "退出登录",
  ...
  "Read-only built-in": "只读内置",
  "Built-in agents are read-only and managed by the server.": "内置智能体为只读，由服务器管理。",
  "Other agents": "其他智能体",
  "Config (YAML)": "配置 (YAML)",
...
"Sync to this machine": "同步到本机",
  ...
  "Local": "本机",
  "Shared": "公用",
  "Shared providers (server)": "服务器公用供应商",
  "Shared providers maintained on the server. Install one to this machine to use it for local execution.": "服务器维护的公用供应商。安装到本机即可用于本地执行。",
  "No shared providers on the server": "服务器上暂无公用供应商",
  "Providers stored in this machine's host config — used when this machine executes agents.": "存储在本机执行配置中的供应商——本机执行 agent 时使用。",
  "No local providers yet": "暂无本机供应商",
  "Install to this machine": "安装到本机",
  "Install this shared provider to this machine": "将此公用供应商安装到本机",
"Storage": "存储位置",
...
"New provider": "新建提供商",
  ...
  "e.g. http://192.168.10.86:4011 (default)": "例如 http://192.168.10.86:4011（默认）",
  "SkillHub registry URL": "技能中心地址",
  "Search skills…": "搜索技能…",
