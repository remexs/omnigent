...
_SDK_AGENT_SPECS: dict[str, dict[str, object]] = {
    "pi-sdk": {
        ...
        "prompt": "You are Pi, running through the SDK executor (no terminal).",
        "executor": {"config": {"harness": "pi"}},
        "spawn": True,
    ...
    "claude-sdk": {
        ...
        "prompt": "You are Claude, running through the SDK executor (no terminal).",
    ...
    "goose-sdk": {
        ...
        "prompt": "You are Goose, running through the SDK executor (no terminal).",
        "executor": {"config": {"harness": "goose"}},
        "spawn": True,
        "interaction": {"modalities": {"input": ["text"], "output": ["text"]}},
    },
    "antigravity-sdk": {
        ...
        "prompt": "You are Antigravity, running through the SDK executor (no terminal).",
        "executor": {"config": {"harness": "antigravity"}},
        "spawn": True,
        "interaction": {"modalities": {"input": ["text"], "output": ["text"]}},
    },
}
...
def create_app(
    ...
    # Registered BEFORE the SPA static mount (below) — a route added after
    # ``mount("/")`` is shadowed by the catch-all fallback and never reached.
